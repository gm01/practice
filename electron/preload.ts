...
contextBridge.exposeInMainWorld("fcOnline", {
  ...
  fetchPlayerDetail: (spId: number, grade: number, options?: { adaptation?: 1 | 5; affiliationId?: number; enhancementId?: number; enhancementLevel?: number; featureId?: number }) => ipcRenderer.invoke("players:detail", { spId, grade, options }),
